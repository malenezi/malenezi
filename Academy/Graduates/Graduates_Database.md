...
| 281 | ياسر صديق | Yasser Seddiq | أكاديمية سدايا للذكاء الاصطناعي التوليدي (بالشراكة مع NVIDIA) — شهادتا NCA | 2025 (~منتصف العام) |  | Technology Expert | Digital Transformation Enabler |  | https://www.linkedin.com/in/yasser-seddiq |  |  |  | https://www.linkedin.com/posts/yasser-seddiq_sdaia-aebaexaepaeyaep-nvidia-ugcPost-7355504056947154946-W9IR/ | 85 | منشور علني (~أغسطس 2025) يوثّق حصوله على شهادتي NVIDIA NCA-GENL وNCA-GENM بدعم أكاديمية سدايا للذكاء الاصطناعي التوليدي. خبير تقنية (دكتوراه). خارج ملف NVIDIA الرسمي (212) — لا يُحتسب ضمنه. |
